...
public class DespesaDAO {
    private PreparedStatement ps; // comandos que vamos executar via SQL OBS: ela depende da conexão
    private ResultSet rs;
    private String sql;

    public void inserir(Despesa despesa) {
        sql = "insert into java_despesa values (secd.nextval, ?, ?, ?, ?)";
    ...
    public List<Despesa> relatorio() {
        ...
        sql = "select d.descricao, d.valor, d.data, c.categoria\n" +
                ...
                "on d.id_categoria = c.id_categoria"; // não coloca ponto e virgula (;)
